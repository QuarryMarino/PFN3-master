        ...
        <main class="bg-[#F5F6FA] h-[84%] w-[100%] px-[20px] py-[10px]">
            <section>
                <div class="flex justify-between items-center mb-[20px]">
                    <h1 class="text-[#2A2A28] text-[20px]">Lista de Permiso</h1>
                    <h3><span class="text-[#6396D5]">Home</span> / Permiso</h3>
                </div>
                <div class="bg-[#ffffff] w-[100%] min-h-[450px] rounded">
                    <div class="flex justify-between items-center border-b border-[#E5E5E5] px-[20px] py-[10px]">
                        <h2 class="text-[18px]">informaión de Permiso</h2>
                        <button id="btnNewUser" class="bg-[#0079FF] py-[5px] px-[20px] text-[white] rounded">Agregar Permiso</button>
                    </div>
                    ...
                    <table class="bg-[#ffffff] max-h-[350px] overflow-auto w-[95%] text-center mx-[auto] mt-[10px] mb-[10px]">
                        <thead class="border border-[#E5E5E5]">
                            <tr>
                                ...
                                <th class="text-[#2A3137] border-r border-[#E5E5E5]">Email</th>
                                <th class="text-[#2A3137] border-r border-[#E5E5E5]">Permiso</th>
                                <th class="text-[#2A3137] border-r border-[#E5E5E5]">Estado</th>
    ...
    <div class="hidden" id="newuser">
        ...
        <form class="grid gap-[2px] absolute z-20 bg-[white] top-[50%] left-[50%] w-[400px] translate-y-[-50%] p-[20px] translate-x-[-50%]" action="../../controller/create_class.php" method="post">
            <div class="flex items-center justify-between mb-[20px]">
                <h2 class="text-[30px]">Editar permiso</h2>
            ...
            <input class="border border-[#858388] rounded" type="email" name="new_email" id="new_email" required>
            <br>

            <label for="new_role">New Role:</label>
            <select class="border border-[#858388] rounded" name="new_role" id="new_role">
            ...
            <div class="flex justify-around">
                <div>
                    <input class="inline-block" type="radio" name="new_active" id="active_yes" value="1" checked>
                    <label for="active_yes">Yes</label>
                </div>
                <div>
                    <input type="radio" name="new_active" id="active_no" value="0">
            ...
            <div class="flex justify-end gap-[5px] mt-[10px]">
                ...
                <button class="bg-[#0079FF] px-[10px] py-[5px] rounded text-[white] btn">crear</button>
            </div>
        </form>
    </div>
</body>
