        ...
        <main class="bg-[#F5F6FA] h-[84%] w-[100%] px-[20px] py-[10px]">
            <section>
                <div class="flex justify-between items-center">
                    <h1 class="text-[#2A2A28] text-[20px]">Dashboard</h1>
                    <h3><span class="text-[#6396D5]">Home</span> / Dashboard</h3>
                </div>
                <div class="bg-[#ffffff] shadow-md w-[700px] mt-[20px] border border-[#EEEFF3] p-[20px]">
                    <h3 class="text-[18px] pb-[5px]">Bienvenido</h3>
                    <p class="text-[15px]">Seleciona la accion que quieras realizar en las pestañas del menu de las izquierda</p>
                </div>
            </section>
        </main>
